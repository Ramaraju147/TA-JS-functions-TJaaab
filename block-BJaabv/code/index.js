...
function calculateDogAge(puppyAge = 0, conversionRate = 7) {
  let dogAge = puppyAge * conversionRate;
  return dogAge;
}
...
function calculateMoviesToWatch(age = 5, movieCount = 1) {
  const maxAge = 75;
  let totalMovies = (maxAge - age) * 48 * movieCount;
  return totalMovies;
}
...
function celsiusToFahrenheit(celsiusTemperature = 0) {
...
function fahrenheitToCelsius(fahrenheitTemperature = 0) {
